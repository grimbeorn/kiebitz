...
<html lang="en-US">
  <head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/b_kiebitz_001.png') }}">
  ...
  <body class="size-1140 primary-color-orange">
        ...
        <nav class="background-white background-transparent-hightlight full-width sticky">
          <div class="s-12 l-2">
            <a href="/" class="logo">
              ...
              <img class="logo-before" src="img/b_logoKiebitz_001.png" alt="" >
              <img class="logo-after" src="img/b_logoKiebitz_001.png" alt="" >
            </a>
          </div>
          <div class="s-12 l-10">
      ...
      <footer>
        ...
        <section class="padding background-dark full-width">
          <div class="text-center">
            <p class="text-size-12">Copyright 2021, Vision Design - Orange Code</p>
          </div>
        </section>
      </footer>
    </div>
    ...
    <!-- Código de instalación Cliengo para zixmonkeys.com --> 
    <script type="text/javascript">(function () { var ldk = document.createElement('script'); ldk.type = 'text/javascript'; ldk.async = true; ldk.src = 'https://s.cliengo.com/weboptimizer/5f13cc0c4c8b34002a11e4c0/5f13cc0e4c8b34002a11e4c3.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ldk, s); })();</script>
    
    <!-- tidio code -->
    <!-- <script src="//code.tidio.co/9dytvu3jx9fq9ux9zsgukyzfvli4v799.js" async></script> -->
