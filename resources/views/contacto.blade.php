      ...
      <div class="s-12 m-12 l-5">
        ...
        {{ csrf_field() }}
          ...
          <div class="line">       
            ...
            <!-- captcha de kiebitz -->
            <!-- <div class="s-12">
              <div class="g-recaptcha" data-sitekey="6LfjV9cbAAAAAGCJD4t1hkwec9CYW7uTqwXXMTJx"></div><br>
            </div>  -->
            
            <div class="s-12 button-parent">
              <button type="submit" class="g-recaptcha submit-form button border-radius text-white background-primary" data-sitekey="6LcF41scAAAAAIeS9Q4tedDWawSMeurSIA4s30Zh" data-callback='onSubmit'>Enviar</button>
            </div>
